...
public class BankServiceSingleCustomerTest {
    ...
    void testInitialCashAccountSetUp() {
        IAccount newAccount = bankService.openAccountWithBank(CUSTOMER_ID_1, mockBank, IAccount.ACCOUNT_TYPE.CASH);
        assertEquals(0, bankService.checkAccountBalance(CUSTOMER_ID_1, newAccount.getAccountNumber()));
    }
    ...
    void testCashAccountBalanceToEqual10AfterDeposit() {
        IAccount newAccount = bankService.openAccountWithBank(CUSTOMER_ID_1, mockBank, IAccount.ACCOUNT_TYPE.CASH);
        bankService.deposit(CUSTOMER_ID_1, newAccount.getAccountNumber(), 10.00);
        assertEquals(10.00, bankService.checkAccountBalance(CUSTOMER_ID_1, newAccount.getAccountNumber()));
    }
